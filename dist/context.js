...
var TableContextProvider = function (_a) {
    ...
    var _b = (0, react_1.useReducer)(store_1.reducer, (0, injectRouteParamsToInitialState_1.injectRouteParamsToInitialState)(store_1.initialState)), state = _b[0], dispatch = _b[1];
    return (0, jsx_runtime_1.jsx)(exports.TableContext.Provider, __assign({ value: { state: state, dispatch: dispatch } }, { children: children }));
};
exports.TableContextProvider = TableContextProvider;
function useTableContext() {
    var context = (0, react_1.useContext)(exports.TableContext);
    if (typeof context === 'undefined')
        throw new Error('useTableContext must be inside a TableProvider with a value');
    return context;
}
