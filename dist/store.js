...
var injectPaginationToRouteParams_1 = require("./helpers/injectPaginationToRouteParams");
...
var setPagination = function (state, action) {
    ...
    (0, injectPaginationToRouteParams_1.injectPaginationToRouteParams)({ page: page, perPage: perPage });
