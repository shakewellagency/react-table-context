...
export type TableAction<T extends TableRecord = TableRecord> = ToggleSelectedAction | ToggleSelectedAllAction | SortAction | SetFilterAction<T> | GoToPageAction | NextPageAction | PrevPageAction | SetPagination | Initialize<T>;
export {};
