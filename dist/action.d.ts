...
export type TableAction<T extends TableRecord = TableRecord> = SetData | ToggleSelectedAction | ToggleSelectedAllAction | SortAction | SetFilterAction<T> | SetFiltersAction<T> | GoToPageAction | NextPageAction | PrevPageAction | SetPagination | Initialize<T>;
export {};
